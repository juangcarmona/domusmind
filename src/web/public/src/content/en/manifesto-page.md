---
title: "Manifesto"
description: "Why the house stops working when one person stops thinking about it."
hero:
  headline: "Stop carrying your household in your head."
  supportLine: "The house should not depend on one person's memory. It needs a shared system that everyone can see."
blocks:
  - title: "The reality"
    body: >-
      In most households, one person carries the house in their head.
      They know what time practice ends, when the school meeting is,
      what the fridge is missing, and who needs to be where next week.
      Nobody asked them to hold all of this. It just happened.
      The house works because one person keeps track of everything.
  - title: "The hidden work"
    body: >-
      This person is not just doing tasks. They are remembering.
      They are anticipating what will be needed. They are coordinating
      between people who do not know what the others need.
      They are reminding, following up, and filling the gaps.
      This work does not appear on any list. It is not visible. It is not shared.
  - title: "The imbalance"
    body: >-
