...
public sealed class ToggleListItemCommandHandler
    : ICommandHandler<ToggleListItemCommand, ToggleListItemResponse>
{
    private readonly IDomusMindDbContext _dbContext;
    private readonly IEventLogWriter _eventLogWriter;
    private readonly IFamilyAuthorizationService _authorizationService;

    public ToggleListItemCommandHandler(
    ...
    public async Task<ToggleListItemResponse> Handle(
        ToggleListItemCommand command,
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            item = list.ToggleItem(itemId, null, now);
        }
        ...
        return new ToggleListItemResponse(
            itemId.Value,
            item.Checked,
            list.UncheckedCount);
    }
