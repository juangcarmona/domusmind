...
public sealed class AssignTaskCommandHandler
    : ICommandHandler<AssignTaskCommand, AssignTaskResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            task.Assign(MemberId.From(command.AssigneeId));
        }
        ...
        return new AssignTaskResponse(command.TaskId, command.AssigneeId, task.Status.ToString());
    }
}
