...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomusMind.Domain.Lists.ListItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("DomusMind.Domain.Lists.SharedList", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("DomusMind.Domain.MealPlanning.Entities.DietaryConstraint", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("dietary_constraints", (string)null);
                });

            modelBuilder.Entity("DomusMind.Domain.MealPlanning.Entities.FamilyPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("DefaultDietaryConstraints")
                        .IsRequired()
                        .HasColumnType("text")
                    ...
                    b.Property<bool>("WeekendFlexibility")
                        .HasColumnType("boolean")
                        .HasColumnName("weekend_flexibility");

                    b.HasKey("Id");

                    b.ToTable("family_preferences", (string)null);
                });

            modelBuilder.Entity("DomusMind.Domain.MealPlanning.Entities.Ingredient", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("DomusMind.Domain.MealPlanning.Entities.MealPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("DomusMind.Domain.MealPlanning.Entities.MealSlot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("DomusMind.Domain.MealPlanning.Entities.MealSlotTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("meal_slot_templates", (string)null);
                });

            modelBuilder.Entity("DomusMind.Domain.MealPlanning.Entities.Recipe", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("DomusMind.Domain.MealPlanning.Entities.ShoppingList", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid?>("GeneratedFromMealPlanId")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DomusMind.Domain.MealPlanning.Entities.ShoppingListItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("DomusMind.Domain.MealPlanning.Entities.WeeklyTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("DomusMind.Domain.Lists.ListItem", b =>
                {
                    b.HasOne("DomusMind.Domain.Lists.SharedList", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("DomusMind.Domain.MealPlanning.Entities.Ingredient", b =>
                {
                    b.HasOne("DomusMind.Domain.MealPlanning.Entities.Recipe", null)
            ...
            modelBuilder.Entity("DomusMind.Domain.MealPlanning.Entities.MealSlot", b =>
                {
                    b.HasOne("DomusMind.Domain.MealPlanning.Entities.MealPlan", null)
                        .WithMany("MealSlots")
            ...
            modelBuilder.Entity("DomusMind.Domain.MealPlanning.Entities.MealSlotTemplate", b =>
                {
                    b.HasOne("DomusMind.Domain.MealPlanning.Entities.WeeklyTemplate", null)
                        .WithMany("MealSlotTemplates")
            ...
            modelBuilder.Entity("DomusMind.Domain.MealPlanning.Entities.ShoppingListItem", b =>
                {
                    b.HasOne("DomusMind.Domain.MealPlanning.Entities.ShoppingList", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("DomusMind.Domain.MealPlanning.Entities.WeeklyTemplate", b =>
                {
                    b.Navigation("MealSlotTemplates");
                });
